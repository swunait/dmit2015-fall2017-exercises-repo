...
public class Invoice implements Serializable {
	...
	public String toString() {
		return "Invoice [invoiceId=" + invoiceId + ", billingAddress=" + billingAddress + ", billingCity=" + billingCity
				+ ", billingCountry=" + billingCountry + ", billingPostalCode=" + billingPostalCode + ", billingState="
				+ billingState + ", invoiceDate=" + invoiceDate + ", total=" + total + ", customer=" + customer
